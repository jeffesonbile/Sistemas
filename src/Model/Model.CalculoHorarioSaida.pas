...
type
  TCalculoHorarioSaida = class
    private
      ...
      const
        MENSSAGEM_ERRO_1 = 'Campo Expediente inválido.' + #13#10 + 'Verifique!';
        MENSSAGEM_ERRO_2 = 'Campo Entrada inválido.' + #13#10 + 'Verifique!';
        MENSSAGEM_ERRO_3 = 'Campo Almoço inválido.' + #13#10 + 'Verifique!';
        MENSSAGEM_ERRO_4 = 'Campo Final almoço inválido.' + #13#10 + 'Verifique!';
        MENSSAGEM_ERRO_5 = 'O horário de incio de almoço não pode ser maior que o horário de entrada'+ #13#10 + 'Verifique!';
        MENSSAGEM_ERRO_6 = 'O horário de final de almoço não pode ser maior que o horário de inicio de almoço'+ #13#10 + 'Verifique!';
    public
