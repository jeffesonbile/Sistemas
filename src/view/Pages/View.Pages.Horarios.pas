...
begin
  ...
  try
    ...
    case calculos.ValidaCampos of
      ...
      1://RETORNOU CÓDIGO DE ERRO 1
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtTempoExpediente.SetFocus;
        end;
      2://RETORNOU CÓDIGO DE ERRO 2
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtHoraInicio.SetFocus;
        end;
      3://RETORNOU CÓDIGO DE ERRO 3
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtHoraSaidaAlmoco.SetFocus;
        end;
      4://RETORNOU CÓDIGO DE ERRO 4
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtHoraRetornoAlmoco.SetFocus;
        end;
      5://RETORNOU CÓDIGO DE ERRO 5
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtHoraSaidaAlmoco.SetFocus;
        end;
      6://RETORNOU CÓDIGO DE ERRO 6
        begin
          Application.MessageBox(calculos.RetornaMensagemErro, 'Atenção', MB_ICONEXCLAMATION + MB_OK);
          edtHoraRetornoAlmoco.SetFocus;
        end;
